...
import { TwitterIcon, InstagramIcon, LinkedinIcon, ArrowRightIcon, CheckCircleIcon, SparklesIcon, TrendingUpIcon, ZapIcon, RocketIcon } from "lucide-react";
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
            Revolutionize Your Social Media with AI-Generated Content
          </h1>
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Generate captivating content for Twitter, Instagram, and LinkedIn
            ...
            {[
              {
                ...
                description:
                  "Develop impactful Twitter threads that connect with your followers and amplify your visibility.",
              },
              {
                ...
                description:
                  "Generate compelling Instagram captions that drive interaction and attract more followers.",
              },
              {
                title: "LinkedIn Posts",
                icon: <LinkedinIcon className="w-10 h-10 mb-4 text-blue-600" />,
                description:
                  "Create impactful LinkedIn content that positions you as a thought leader in your industry.",
              },
            ].map((feature, index) => (
              <div
                key={index}
        ...
        <div className="py-20 bg-gray-900 rounded-3xl my-20 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                "Streamline your content creation process and save valuable time",
                "Deliver top-quality posts with consistency and ease",
                "Boost engagement on all your social media channels",
                "Keep up with the latest trends in social media effortlessly",
                "Tailor your content to perfectly align with your brand's voice",
                "Effortlessly expand your social media reach and influence",
              ].map((benefit, index) => (
